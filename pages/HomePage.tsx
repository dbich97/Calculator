...
const CalculatorCard: React.FC<{ to: string; title: string; description: string; icon: string; }> = ({ to, title, description, icon }) => (
    <Link to={to} className="block bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 ease-in-out">
      ...
      <section className="py-12 md:py-16 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <CalculatorCard to={`/${currentLang}/calculator`} title={t.navCalculator} description={t.seoDescription.split('.')[0]} icon="🎂" />
                <CalculatorCard to={`/${currentLang}/pregnancy-calculator`} title={t.navPregnancyCalculator} description={t.homePregnancyCalculatorDescription} icon="🤰" />
